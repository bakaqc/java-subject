...
public class ArrayOfSquare {
    ...
    public ArrayOfSquare() {
        this.a = new Square[10];
        this.n = 0;
    }

    //hàm khởi tạo có đối số
    public ArrayOfSquare(int capacity) {
        this.a = new Square[capacity];
        this.n = 0;
    }
    ...
    public Square set(int index, Square e) {
        if (index < 0 || index >= n) {
            System.out.println("Invalid index");
            System.exit(0);
        }
...
//    }
    ...
    public boolean contains(Square x) {
    ...
    //Hàm input, output
    public void input(ArrayOfSquare a) {
        a.add(new Square(5), 1);
        a.add(new Square(6), 2);
    }
